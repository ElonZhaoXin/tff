...
public class QrcodeUtils {
     ...
     * @return 二维码图片的字节数组
     */
    private static byte[] createQrcode(String content, int length, File logoFile, MatrixToLogoImageConfig logoConfig) {
     ...
     * @return 二维码图片的字节数组
     */
    private static byte[] createQrcode(String content, int length, File logoFile) {
     ...
     * @return 二维码图片的字节数组
     */
    private static byte[] createQrcode(String content, File logoFile) {
     ...
     * 可以指定是否加logo
     * @param content  二维码内容
     * @return 二维码图片base64字符串
     */
    public static String createQrcodeBase64(String content, File logoFile) {
        return Base64.getEncoder().encodeToString(QrcodeUtils.createQrcode(content, logoFile));
    }
